TP integrador de la materia Principios y Técnicas de Compiladores. Consiste en un compilador desarrollado con la herramienta SLY (https://github.com/dabeaz/sly.git)

El presente trabajo práctico integrador tiene como objetivo principal el desarrollo de un compilador completo para un lenguaje de programación específico. Este proyecto se llevará a cabo a lo largo de varias entregas, lo que nos permitirá abordar las distintas etapas de la compilación de manera modular y escalonada.
